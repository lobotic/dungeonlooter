(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=function(e){return e.Goblin=`goblin`,e.Skeleton=`skeleton`,e.Orc=`orc`,e.Spider=`spider`,e.Dragon=`dragon`,e}({}),t=function(e){return e.Warrior=`warrior`,e.Archer=`archer`,e.Mage=`mage`,e}({}),n={warrior:{type:`warrior`,name:`Warrior`,icon:`🛡️`,maxHealth:10,health:10,damage:{[e.Goblin]:1,[e.Skeleton]:2,[e.Orc]:3,[e.Spider]:1,[e.Dragon]:5}},archer:{type:`archer`,name:`Archer`,icon:`🏹`,maxHealth:10,health:10,damage:{[e.Goblin]:2,[e.Skeleton]:3,[e.Orc]:1,[e.Spider]:1,[e.Dragon]:5}},mage:{type:`mage`,name:`Mage`,icon:`🧙`,maxHealth:10,health:10,damage:{[e.Goblin]:3,[e.Skeleton]:1,[e.Orc]:2,[e.Spider]:1,[e.Dragon]:5}}};function r(e){return structuredClone(n[e])}var i=function(e){return e.Empty=`empty`,e.Goblin=`goblin`,e.Skeleton=`skeleton`,e.Orc=`orc`,e.Spider=`spider`,e.Dragon=`dragon`,e.Trap=`trap`,e.Treasure=`treasure`,e}({}),a=class{tiles=[];constructor(){for(let e=0;e<6;e++){let t=[];for(let n=0;n<6;n++)t.push({position:{x:n,y:e},revealed:!1,resolved:!1,marked:!1,isStart:n===0&&e===0,isExit:n===5&&e===5,content:`empty`,combatHint:0,trapHint:0,treasureDirection:`•`});this.tiles.push(t)}this.tiles[0][0].revealed=!0,this.tiles[0][0].resolved=!0}getTile(e,t){return this.tiles[t][e]}reveal(e,t){this.tiles[t][e].revealed=!0}isInside(e,t){return e>=0&&e<6&&t>=0&&t<6}},o=class{seed;constructor(e){this.seed=e}next(){return this.seed=this.seed*1664525+1013904223>>>0,this.seed}nextFloat(){return this.next()/4294967296}nextInt(e){return Math.floor(this.nextFloat()*e)}},s=class{static calculate(e,t){this.calculateTreasureDirections(e),this.calculateTrapHints(e),this.calculateCombatHints(e,t)}static calculateTrapHints(e){for(let t=0;t<6;t++)for(let n=0;n<6;n++){let r=0;for(let a=-1;a<=1;a++)for(let o=-1;o<=1;o++){if(o===0&&a===0)continue;let s=n+o,c=t+a;s<0||c<0||s>=6||c>=6||e.getTile(s,c).content===i.Trap&&r++}e.getTile(n,t).trapHint=r}}static calculateCombatHints(t,n){for(let r=0;r<6;r++)for(let a=0;a<6;a++){let o=0;for(let s=-1;s<=1;s++)for(let c=-1;c<=1;c++){if(c===0&&s===0)continue;let l=a+c,u=r+s;if(!(l<0||u<0||l>=6||u>=6))switch(t.getTile(l,u).content){case i.Goblin:o+=n.damage[e.Goblin];break;case i.Skeleton:o+=n.damage[e.Skeleton];break;case i.Orc:o+=n.damage[e.Orc];break;case i.Spider:o+=n.damage[e.Spider];break;case i.Dragon:o+=n.damage[e.Dragon];break}}t.getTile(a,r).combatHint=o}}static calculateTreasureDirections(e){let t=0,n=0;for(let r=0;r<6;r++)for(let a=0;a<6;a++)if(e.getTile(a,r).content===i.Treasure){t=a,n=r;break}for(let r=0;r<6;r++)for(let i=0;i<6;i++)e.getTile(i,r).treasureDirection=this.directionTo(i,r,t,n)}static directionTo(e,t,n,r){let i=Math.sign(n-e),a=Math.sign(r-t);return i===0&&a===0?`•`:i===0&&a===-1?`↑`:i===1&&a===-1?`↗`:i===1&&a===0?`→`:i===1&&a===1?`↘`:i===0&&a===1?`↓`:i===-1&&a===1?`↙`:i===-1&&a===0?`←`:`↖`}},c=`dungeon-looter-daily`,l=`dungeon-looter-stats`;function u(){return JSON.parse(localStorage.getItem(c)??`{}`)}function d(e){localStorage.setItem(c,JSON.stringify(e))}function f(){let e=JSON.parse(localStorage.getItem(l)??JSON.stringify({games:0,wins:0,losses:0,totalGold:0,totalEnemies:0,bestGold:0,winStreak:0,streakGold:0,bestWinStreak:0}));return e.streakGold??=0,e}function p(e){localStorage.setItem(l,JSON.stringify(e))}function m(e){localStorage.setItem(`dungeon-looter-game`,JSON.stringify(e))}function h(){let e=localStorage.getItem(`dungeon-looter-game`);return e?JSON.parse(e):null}function g(){localStorage.removeItem(`dungeon-looter-game`)}var _=function(e){return e[e.Explore=0]=`Explore`,e[e.Mark=1]=`Mark`,e[e.Scroll=2]=`Scroll`,e}({}),v=class{board;rng;mode;hero;heroX;heroY;gold;scrolls;gameOver;victory;enemiesKilled;alreadyPlayed;constructor(e){let t=new Date,n=t.getFullYear()*1e4+(t.getMonth()+1)*100+t.getDate();this.mode=0,this.rng=new o(n),this.board=new a,this.hero=r(e),this.heroX=0,this.heroY=0,this.gold=0,this.scrolls=0,this.gameOver=!1,this.victory=!1,this.enemiesKilled=0,this.alreadyPlayed=!1,u()[this.getTodayKey()]&&(this.alreadyPlayed=!0);let i=h();i&&i.date===this.getTodayKey()?(this.board.tiles=i.board,this.heroX=i.heroX,this.heroY=i.heroY,this.hero.health=i.health,this.gold=i.gold,this.scrolls=i.scrolls,this.enemiesKilled=i.enemiesKilled,this.mode=i.mode):(g(),this.generateDungeon(),s.calculate(this.board,this.hero))}generateDungeon(){this.placeRandom(i.Treasure),this.placeRandom(i.Dragon),this.placeRandom(i.Goblin),this.placeRandom(i.Skeleton),this.placeRandom(i.Orc),this.placeRandom(i.Spider);let e=6+this.rng.nextInt(5);for(let t=0;t<e;t++)this.placeRandom(i.Trap)}placeRandom(e){for(;;){let t=this.rng.nextInt(6),n=this.rng.nextInt(6),r=this.board.getTile(t,n);if(!(r.isStart||r.isExit)&&r.content===i.Empty){r.content=e;return}}}getTodayKey(){let e=new Date;return String(e.getFullYear()*1e4+(e.getMonth()+1)*100+e.getDate())}saveResult(){let e=u();e[this.getTodayKey()]={played:!0,hero:this.hero.name,victory:this.victory,health:this.hero.health,gold:this.gold,scrolls:this.scrolls,enemies:this.enemiesKilled},d(e);let t=f();t.games++,this.victory?(t.wins++,t.winStreak++,t.streakGold+=this.gold,t.winStreak>t.bestWinStreak&&(t.bestWinStreak=t.winStreak)):(t.losses++,t.winStreak=0,t.streakGold=0),t.totalGold+=this.gold,t.totalEnemies+=this.enemiesKilled,this.gold>t.bestGold&&(t.bestGold=this.gold),p(t),g()}rewardEnemy(){this.rng.nextInt(10)<7?this.gold++:this.scrolls++}saveGame(){m({date:this.getTodayKey(),heroX:this.heroX,heroY:this.heroY,health:this.hero.health,gold:this.gold,scrolls:this.scrolls,enemiesKilled:this.enemiesKilled,mode:this.mode,board:this.board.tiles})}copyResults(){let e=u()[this.getTodayKey()],t=f(),n=`🏰 Dungeon Looter ${this.getTodayKey()}
